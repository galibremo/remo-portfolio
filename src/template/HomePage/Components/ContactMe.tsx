...
export default function ContactMe({ intro, cards }: ContactMeProps) {
	...
	return (
		<section id="contactme" className="relative bg-muted/30 py-12">
			<div className="mx-auto max-w-6xl px-6">
				...
				<div className="grid grid-cols-1 items-stretch gap-8 md:grid-cols-12">
					...
					<div className="flex md:col-span-7">
						...
						>
							<Card className="glass-card-light h-full overflow-hidden rounded-3xl border border-border/60 shadow-xl p-6 gap-0">
								<CardHeader className="pb-4 text-left px-0">
