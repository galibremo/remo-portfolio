...
export default function Quots({ items, backgroundImage }: QuotsProps) {
	...
	return (
		<section id="quotes" className="relative overflow-hidden py-16">
			<div
			...
			>
				...
				<div className="pointer-events-none absolute top-1/2 left-1/2 h-100 w-100 -translate-x-1/2 -translate-y-1/2 rounded-full bg-purple-500/20 blur-[100px]"></div>
			</div>
			...
			<div className="relative z-10 mx-auto max-w-6xl px-6">
				...
				<Swiper
					...
					speed={800}
					loop={items.length > 1}
					className="[--swiper-pagination-bullet-inactive-color:#fff] [--swiper-pagination-bullet-inactive-opacity:0.45] [--swiper-pagination-color:#c084fc]"
